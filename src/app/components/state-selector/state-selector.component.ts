...
export class StateSelectorComponent implements OnInit {
  ...
  constructor(private localOfficialsService: LocalOfficialsService) {
    // Initialize with current state from service
    this.selectedState = this.localOfficialsService.getCurrentState();
  }

  ngOnInit() {
    // No need to set initial state as it's already maintained by the service
  }

  onStateChange(state: string) {
    this.localOfficialsService.setState(state);
  }
} 